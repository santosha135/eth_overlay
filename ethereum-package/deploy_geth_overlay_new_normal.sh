...
# Configuration
IMAGE_NAME="geth-overlay-normal:local"
IMAGE_TAR="geth-overlay-normal-local.tar"
#GETH_SRC="/home/narwhal/eth_overlay/new_go-ethereum/go-ethereum/build/bin/geth"
GETH_SRC="/home/narwhal/eth_overlay/go-ethereum/build/bin/geth"
GETH_DST="docker/geth-overlay-normal/geth"
...
echo "======================================="
docker build --no-cache -t "$IMAGE_NAME" docker/geth-overlay-normal/
