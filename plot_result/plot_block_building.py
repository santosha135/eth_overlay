...
FILES = {
    "5 Buckets":  "block_build_duration_summary_5_bucket.xlsx",
    "10 Buckets": "block_build_duration_summary_10_bucket.xlsx",
    "15 Buckets": "block_build_duration_summary_15_bucket.xlsx",
    "30 Buckets": "block_build_duration_summary_30_bucket.xlsx",
}

COLUMN = "average_block_build_duration_ns"
...
ax.set_ylabel(
    "Average Block Building Duration (µs)",
    fontsize=12
)
...
plt.savefig(
    "block_building_duration_sem.png",
    dpi=300,
    bbox_inches="tight"
)

plt.savefig(
    "block_building_duration_sem.pdf",
    bbox_inches="tight"
)
...
print("\n")
print("=" * 75)
print("FINAL BLOCK BUILDING RESULTS")
print("=" * 75)
...
summary.to_excel(
    "block_building_bucket_comparison_sem.xlsx",
    index=False
)